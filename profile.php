...
<div id="container">
    ...
    <div class="square">
        ...
        <div class="tile1">
            <a href="" class="tilelink"><i class="icon-cog-alt"></i> <br />Twój Profil</a>
        </div>
    ...
    <div class="square">
        <div class="tile5">
            <input type="button" name="login" value="Nazwa użytkownika">
            <input type="button" value="Zmiana hasła"> <br /><br /><br />
            Twoje ulubione utwory: <br />

<!--       <div id="player">
                 <audio controls><source src="AlbertoRuiz.mp3" type="audio/mpeg"></audio>
           </div> -->
            <br /><br />
